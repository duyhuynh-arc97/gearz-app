...
class ModifyContactScreen extends StatefulWidget {
  final AdditionalContact? contact;
  const ModifyContactScreen({Key? key, this.contact}) : super(key: key);

  @override
  _ModifyContactScreenState createState() => _ModifyContactScreenState();
}

class _ModifyContactScreenState extends State<ModifyContactScreen> {
  ...
  AdditionalContactController _additionalContactController = Get.find();

  List<District> _districts = [];
  List<Ward> _wards = [];

  City _selectedCity = City(id: 0, code: "", name: "");
  District _selectedDtr = District(id: 0, name: "", cityId: 0);
  Ward _selectedWard = Ward(id: 0, name: "", districtId: 0);
  ...
  void initState() {
    ...
    if (widget.contact != null) {
      ...
      _selectedDtr = widget.contact!.district!;
      _selectedWard = widget.contact!.ward!;
    }
    ...
    _addressController = TextEditingController(
        text: widget.contact == null ? "" : widget.contact!.addressLine);
    _addressController.addListener(() {
      setState(() {});
    });

    _cityController = TextEditingController(
        text: widget.contact == null ? "" : widget.contact!.city!.name);
    _cityController.addListener(() {
      setState(() {});
    });

    _districtController = TextEditingController(
        text: widget.contact == null ? "" : widget.contact!.district!.name);
    _districtController.addListener(() {
      setState(() {});
    });

    _wardController = TextEditingController(
        text: widget.contact == null ? "" : widget.contact!.ward!.name);
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          leading: IconButton(
              onPressed: () {
                Get.back();
                _additionalContactController.update();
              },
              icon: Icon(
                ...
                child: DraggableScrollableSheet(
                  ...
                  builder: (_, controller) => Container(
                    ...
                    child: _selectedDtr.id == 0
                        ...
                        : FutureBuilder(
                            future:
                                _addressAPIController.getWards(_selectedDtr.id),
                            builder: (context, AsyncSnapshot snapshot) {
                              if (!snapshot.hasData) {
                                return Center(
                                    child: CircularProgressIndicator(
    ...
    return Container(
      ...
      child: ElevatedButton(
        onPressed: () async {
          if (_formKey.currentState!.validate()) {
            ...
            if (widget.contact == null) {
              _additionalContactController
                ...
                if (value == true) {
                  ...
                  Get.snackbar(
                    ...
                    "Your new contact has been added. You can check in Your profile.",
              ...
              var res = await _additionalContactController.updateContact(
              ...
              if (res == true) {
                ...
                openSuccessMessageDialog(
                    ...
                    mainText:
                        "Your contact has been updated. You can check in ",
                    importantText: "Your profile.",
                    additionalText: "",
                    iconName: "success.png",
                    action: () {
                      _additionalContactController.contactList
                          .singleWhere(
        ...
        child: _isLoading == false
            ? Text(widget.contact == null ? 'Add' : "Update",
                style: TextStyle(

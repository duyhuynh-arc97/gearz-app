...
class _ToReceiveScreenState extends State<ToReceiveScreen> {
  ...
  void initState() {
    super.initState();
    _incomingOrders = _orderController.myOrders
        .where((p0) =>
            p0.finalTrack.status == "PACKAGED" ||
            p0.finalTrack.status == "PICKED" ||
            p0.finalTrack.status == "SHIPPING")
        .toList();
  }
              ...
              Row(
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(
                        color: Colors.green, fontSize: 14 * fontScale(context)),
                  )
                ],
              ),
            ],
